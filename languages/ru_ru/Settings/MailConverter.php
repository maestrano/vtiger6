...
$languageStrings = array(
    ...
    'LBL_CONNECTION_TO_MAILBOX_FAILED' => "Подключение к почтовому ящику не удалось! Инструменты Специальные символы не допускаются для названия сервера и имя пользователя.",
